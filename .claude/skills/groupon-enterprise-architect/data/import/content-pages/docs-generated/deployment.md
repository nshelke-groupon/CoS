...
The Content Pages service is a stateless Node.js iTier application deployed as a container within the Continuum platform. It follows the standard Groupon Continuum deployment model — containerized via Docker, orchestrated on Kubernetes, and deployed across development, staging, and production environments. Static assets are compiled by webpack and served via the Groupon CDN.
...
| CDN | Groupon CDN | Webpack-compiled static assets (JS/CSS bundles) served via CDN |
...
3. Build: webpack client-side bundle compilation
