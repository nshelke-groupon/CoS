...
subscription-programs-itier is a Continuum platform web application deployed as a containerized Node.js service. It runs within the Groupon internal Kubernetes infrastructure. Deployment configuration is managed externally to this service repository. The service has no dedicated architecture folder; deployment and infrastructure manifests are maintained by the platform team.

## Infrastructure

| Component | Technology | Details |
|-----------|-----------|---------|
| Container | Docker | Node.js 10.16.3 base image; built from service Dockerfile |
...
| CDN | Akamai | Edge caching for static assets |
...
| Production | Live customer traffic | US (primary) | groupon.com/programs/select |
...
6. Smoke Test: Validates `/programs/select` and `/programs/select/benefits` respond correctly in staging
