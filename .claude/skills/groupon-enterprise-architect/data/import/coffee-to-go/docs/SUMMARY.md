...
*   **Owner's Manual**: For information on how to operate, deploy, and troubleshoot the application, please refer to the [OWNERS_MANUAL.md](https://github.groupondev.com/automation/coffee-to-go/blob/main/OWNERS_MANUAL.md).
*   **GitHub Repository**: The source code is hosted at [https://github.groupondev.com/](https://github.groupondev.com/).
